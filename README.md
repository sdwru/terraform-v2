...
[![Build Status](https://travis-ci.com/DigitalOceanPHP/TerraFormV2.svg?branch=master)](https://travis-ci.com/github/DigitalOceanPHP/TerraFormV2)
...
parameters:
    do.class.factory: TerraFormV2\TerraFormV2
    do.class.adapter: TerraFormV2\Adapter\GuzzleAdapter
    ....
...
parameters:
    ....
    do.class.api.droplet: TerraFormV2\Api\Droplet
    do.class.api.action: TerraFormV2\Api\Action
    do.class.api.domain: ...
...
To wrap your own response message, please inject your own `ExceptionInterface` if needed (see `TerraFormV2\Exception\ResponseException` for more info).
...
$digitalocean = new TerraFormV2($adapter);
...
Please see [CONTRIBUTING](https://github.com/DigitalOceanPHP/TerraFormV2/blob/master/CONTRIBUTING.md) for details.

Changelog
---------

Please see [CHANGELOG](https://github.com/DigitalOceanPHP/TerraFormV2/blob/master/CHANGELOG.md) for details.
...
* [All contributors](https://github.com/DigitalOceanPHP/TerraFormV2/contributors)

Support
-------

[Please open an issue in github](https://github.com/DigitalOceanPHP/TerraFormV2/issues)
...
[LICENSE](https://github.com/DigitalOceanPHP/TerraFormV2/blob/master/LICENSE) file for details.
