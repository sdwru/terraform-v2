...
class ImageSpec extends \PhpSpec\ObjectBehavior
{
    ...
    {
        $adapter->get('https://api.terraform.com/v2/images?per_page=200')->willReturn('{"images": []}');
    ...
    public function it_returns_an_array_of_image_entity($adapter)
    {
        $total = 3;
        $adapter
            ->get('https://api.terraform.com/v2/images?per_page=200')
    ...
    public function it_returns_an_array_of_distribution_image_entity($adapter)
    {
        $total = 3;
        $adapter
            ->get('https://api.terraform.com/v2/images?per_page=200'.'&type=distribution')
            ->willReturn(sprintf('{"images": [{},{},{}], "meta": {"total": %d}}', $total));
    ...
    public function it_returns_an_array_of_application_image_entity($adapter)
    {
        $total = 3;
        $adapter
            ->get('https://api.terraform.com/v2/images?per_page=200'.'&type=application')
            ->willReturn(sprintf('{"images": [{},{},{}], "meta": {"total": %d}}', $total));
    ...
    public function it_returns_an_array_of_private_application_image_entity($adapter)
    {
        $total = 3;
        $adapter
            ->get('https://api.terraform.com/v2/images?per_page=200'.'&type=application&private=true')
            ->willReturn(sprintf('{"images": [{},{},{}], "meta": {"total": %d}}', $total));
    ...
    public function it_returns_an_array_of_private_image_entity($adapter)
    {
        $total = 3;
        $adapter
            ->get('https://api.terraform.com/v2/images?per_page=200'.'&private=true')
            ->willReturn(sprintf('{"images": [{},{},{}], "meta": {"total": %d}}', $total));
    ...
    {
        $adapter
            ->get('https://api.terraform.com/v2/images/123')
            ->willReturn('
                {
                    "image": {
                        "id": 123,
    ...
    {
        $adapter
            ->get('https://api.terraform.com/v2/images/foo-bar')
            ->willReturn('
                {
                    "image": {
                        "id": 456,
    ...
    {
        $adapter
            ->put('https://api.terraform.com/v2/images/123', ['name' => 'bar-baz'])
            ->willReturn('
                {
                    "image": {
                        "id": 123,
    ...
    {
        $adapter
            ->put('https://api.terraform.com/v2/images/0', ['name' => 'baz-baz'])
    ...
    {
        $adapter
            ->delete('https://api.terraform.com/v2/images/678')
            ->shouldBeCalled();
    ...
    {
        $adapter
            ->delete('https://api.terraform.com/v2/images/0')
            ->willThrow(new HttpException('Request not processed.'));
    ...
    {
        $adapter
            ->post('https://api.terraform.com/v2/images/123/actions', ['type' => 'transfer', 'region' => 'nyc2'])
            ->willReturn('
                {
                    "action": {
                        "id": 22,
    ...
    {
        $adapter
            ->post('https://api.terraform.com/v2/images/0/actions', ['type' => 'transfer', 'region' => 'foo'])
            ->willThrow(new HttpException('Request not processed.'));
    ...
    {
        $adapter
            ->post('https://api.terraform.com/v2/images/123/actions', ['type' => 'convert'])
            ->willReturn('
                {
                    "action": {
                        "id": 22,
    ...
    {
        $adapter
            ->get('https://api.terraform.com/v2/images/123/actions/456')
            ->willReturn('
                {
                    "action": {
                        "id": 22,
    ...
    {
        $adapter
            ->get('https://api.terraform.com/v2/images/0/actions/0')
            ->willThrow(new HttpException('Request not processed.'));
